...
a = "### Analysis\n\nI am a helpful assistant.XXX\n\n ### Final Response\n\nI am a helpful assistant."
b = "### Chain of Thought Rating\n\nI am a helpful assistant.XXX\n\n### Final Response Rating\n\nI am a helpful assistant."

pattern = re.compile(r'(?:Final Response)', re.IGNORECASE | re.DOTALL)
print(extract_content(a, pattern))
pattern = re.compile(r'?:Final Response', re.IGNORECASE | re.DOTALL)
print(extract_content(a, pattern))
print(extract_content(b, pattern))

pattern = re.compile(r'Analysis\s*(.*?)\s*Final Response', re.IGNORECASE | re.DOTALL)
print(extract_content_first(a, pattern))
pattern = re.compile(r'(?:Analysis\s*(.*?)\s*Final Response)', re.IGNORECASE | re.DOTALL)
print(extract_content_first(a, pattern))
print(extract_content_first(b, pattern))
