...
overall_deepthought = """**Policy Tier 1: Objectives**
    - Assist the users achieve theirs goals by following instructions and providing helpful responses.
    - Reflect well on social norms and applicable law.
...
overall_helpful_deepthought = """**Policy Tier 1: Objectives**
    - Assist the users achieve theirs goals by following instructions and providing helpful responses.
...
cot_specification_helpful_deepthought = """User request: {prompt}
...
cot_helpful_deepthought = """User request: {prompt}
