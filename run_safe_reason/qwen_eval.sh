...
prefix="safe_eval"
# ['llama3_sft_gsm8k_tbs16_ebs16_lr1e-6_cl2048', 'gpt-4o-mini-2024-07-18', 'gpt-4o-2024-11-20', 'llama-3-8b-instruct', 'gemma-2-9b-it', 'qwq-32b-preview']
...
export model_name_or_path="Qwen/QwQ-32B-Preview"

if [ ! -f server_logs/${experiment_name}.yaml ] && [[ ${model} != *"gpt"* ]]; then
    envsubst < examples/inference/qwen_vllm.yaml > server_logs/${experiment_name}.yaml
