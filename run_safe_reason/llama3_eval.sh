...
# jailbreak='none'
# ['none', 'cot_specification', 'cot_specification_simplified', 'cot_instruction', 'cot_simple', 'cot_helpful', 'cot_specification_helpful']
cot_prompt='cot_specification_helpful'
