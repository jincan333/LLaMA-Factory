...
export dataset="constrained_answer_sft_preliminary_ruliad-deepthought-8b-llama-v0.01-alpha_5_1_50_1000_0"
...
envsubst < examples/train_full/deepthought_full_sft.yaml > safe_reason_logs/${experiment_name}.yaml
